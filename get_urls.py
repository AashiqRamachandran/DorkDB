...
advisories_and_vulns_object=open(r"/home/ar/Automating dorks/dorks/advisories_and_vulnerabilities.dorks", "r")
advisories_and_vulns_list=advisories_and_vulns_object.readlines()

error_messages_object=open(r"/home/ar/Automating dorks/dorks/error_messages.dorks","r")
error_messages_list=error_messages_object.readlines()

files_containing_juicy_info_object=open(r"/home/ar/Automating dorks/dorks/files_containing_juicy_info.dorks","r")
...
footholds_object=open(r"/home/ar/Automating dorks/dorks/footholds.dorks","r")
footholds_list=footholds_object.readlines()

network_vulnerability_data_object=open(r"/home/ar/Automating dorks/dorks/network_or_vulnerability_data.dorks","r")
network_vulnerability_data_list=network_vulnerability_data_object.readlines()

pages_containing_login_portals_object=open(r"/home/ar/Automating dorks/dorks/pages_containing_login_portals.dorks","r")
pages_containing_login_portals_list=pages_containing_login_portals_object.readlines()

sensitive_directories_object=open(r"/home/ar/Automating dorks/dorks/sensitive_directories.dorks","r")
sensitive_directories_list=sensitive_directories_object.readlines()

sensitive_online_shopping_object=open(r"/home/ar/Automating dorks/dorks/sensitive_online_shopping_info.dorks","r")
sensitive_online_shopping_list=sensitive_online_shopping_object.readlines()

various_online_devices_object=open(r"/home/ar/Automating dorks/dorks/various_online_devices.dorks","r")
various_online_devices_list=various_online_devices_object.readlines()

vulnerable_files_object=open(r"/home/ar/Automating dorks/dorks/vulnerable_files.dorks","r")
vulnerable_files_list=vulnerable_files_object.readlines()

vulnerable_servers_object=open(r"/home/ar/Automating dorks/dorks/vulnerable_servers.dorks","r")
vulnerable_servers_list=vulnerable_servers_object.readlines()

web_server_detection_object=open(r"/home/ar/Automating dorks/dorks/web_server_detection.dorks","r")
